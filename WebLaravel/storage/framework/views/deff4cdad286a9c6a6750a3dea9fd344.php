...
<body>
    <div class="container m-5">
        ...
        <div class="list-group list-group-numbered mt-4">
            ...
            <h6 class="mt-4">Tugas Clone Web</h6>
            <a href="<?php echo e(url('/webBoots')); ?>" class="list-group-item list-group-item-action">
                Web Clone
            </a>
...
<?php /**PATH C:\Users\Daffa Yusuf\Modul11PAW\resources\views/routing.blade.php ENDPATH**/ ?>