  ...
  <nav class="navbar navbar-expand-lg bg-light custom-navbar">
    <div class="container">
      <a href="#" class="navbar-brand">
        <img class="rounded-circle img-fluid" src=<?php echo e(Vite::asset('resources/images/Logo.png')); ?> alt="logo" style="width: 50px">
      </a>
...
<div class="bg py-5" id="main">
  <div class="mb container py-3 px-4">
      <div class="row d-flex justify-content-center align-items-center">
          ...
          <div class="col-md-5">
              <img class="img-fluid" src=<?php echo e(Vite::asset('resources/images/Gyoza1.png')); ?> alt="main logo">
          </div>
      </div>
  </div>
</div>
        ...
        <div class="row gx-1">
          ...
          <div class="bd col-md-6 col-12 mx-3 rounded p-3 shadow d-flex m-2">
            <div class="review-content px-4">
              <img class="rounded-circle" style="width: 50px; height: 50px;" src=<?php echo e(Vite::asset('resources/images/Asyifah.png')); ?>
          ...
          <div class="bd col-md-6 col-12 mx-3 rounded p-3 shadow d-flex m-2">
            <div class="review-content px-4">
              <img class="rounded-circle" style="width: 50px; height: 50px;" src=<?php echo e(Vite::asset('resources/images/Rosyidah.png')); ?>
  ...
  <div class="container py-4 px-4">
      <div class="row d-flex justify-content-center">
        <div class="col-md-5 px-3 d-flex justify-content-center align-items-center">
          <img class="img-fluid mx-md-5" src=<?php echo e(Vite::asset('resources/images/Gyoza2.png')); ?> alt="main logo">
      </div>
          <div class="col-md-7 text-center text-md-start mt">
                  ...
                  <div class="carousel-inner text-center" style="color: #6F381B;">
                    ...
                    <div class="carousel-item active">
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="p-3 bg-white rounded-4 fw-medium mx-2" style="width: 250px; min-height: 320px;">
                          <img class="img-fluid rounded-2 mb-3" style="width: 100%; height: 10em;" src=<?php echo e(Vite::asset('resources/images/GyozaMentai.jpg')); ?> alt="Gyoza Saus Mentai">
                          <div>Gyoza Saus Mentai Special</div>
                          <div>$12</div>
                        </div>
                        <!-- Item 2 -->
                        <div class="p-3 bg-white rounded-4 fw-medium mx-2" style="width: 250px; min-height: 320px;">
                          <img class="img-fluid rounded-2 mb-3" style="width: 100%; height: 10em;" src=<?php echo e(Vite::asset('resources/images/GyozaKering.jpg')); ?> alt="Gyoza Kering">
                    ...
                    <div class="carousel-item">
                      <div class="d-flex justify-content-center">
                        <!-- Item 3 -->
                        <div class="p-3 bg-white rounded-4 fw-medium mx-2" style="width: 250px; min-height: 320px;">
                          <img class="img-fluid rounded-2 mb-3" style="width: 100%; height: 10em;" src=<?php echo e(Vite::asset('resources/images/GyozaRebus.jpg')); ?> alt="Gyoza Rebus">
                        ...
                        <!-- Item 4 -->
                        <div class="p-3 bg-white rounded-4 fw-medium mx-2" style="width: 250px; min-height: 320px;">
                          <img class="img-fluid rounded-2 mb-3" style="width: 100%; height: 10em;" src=<?php echo e(Vite::asset('resources/images/GyozaMentai.jpg')); ?> alt="Gyoza Saus Mentai 2">
...
<?php /**PATH C:\Users\Daffa Yusuf\Modul11PAW\resources\views/webBoots.blade.php ENDPATH**/ ?>